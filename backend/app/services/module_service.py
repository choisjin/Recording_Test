        ...
        functions = [
            {
                ...
                "params": [
                    ...
                    {"name": "x", "required": False, "default": "'0'", "description": "영역 좌상단 X (Region 모드)"},
                    {"name": "y", "required": False, "default": "'0'", "description": "영역 좌상단 Y (Region 모드)"},
                    {"name": "width", "required": False, "default": "'0'", "description": "영역 너비 (Region 모드)"},
                    {"name": "height", "required": False, "default": "'0'", "description": "영역 높이 (Region 모드)"},
