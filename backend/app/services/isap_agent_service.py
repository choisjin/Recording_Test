...
ISAP_KEYS: dict[str, dict] = {
    ...
    # 두 번째 SWRC CUSTOM 키값 무차별 탐색 (스펙 미확인) — 실패: 0x02,0x12,0x13,0x14,0x20,0x21,0x27,0x28,0x29,0x2A
    "SWRC_TEST_03":     {"cmd": CMD_SWRC, "key": 0x03},
    "SWRC_TEST_04":     {"cmd": CMD_SWRC, "key": 0x04},
    "SWRC_TEST_05":     {"cmd": CMD_SWRC, "key": 0x05},
    "SWRC_TEST_06":     {"cmd": CMD_SWRC, "key": 0x06},
    "SWRC_TEST_07":     {"cmd": CMD_SWRC, "key": 0x07},
    "SWRC_TEST_08":     {"cmd": CMD_SWRC, "key": 0x08},
    "SWRC_TEST_09":     {"cmd": CMD_SWRC, "key": 0x09},
    "SWRC_TEST_0A":     {"cmd": CMD_SWRC, "key": 0x0A},
    "SWRC_TEST_0B":     {"cmd": CMD_SWRC, "key": 0x0B},
    "SWRC_TEST_0C":     {"cmd": CMD_SWRC, "key": 0x0C},
    "SWRC_TEST_0D":     {"cmd": CMD_SWRC, "key": 0x0D},
    "SWRC_TEST_0E":     {"cmd": CMD_SWRC, "key": 0x0E},
    "SWRC_TEST_15":     {"cmd": CMD_SWRC, "key": 0x15},
    "SWRC_TEST_16":     {"cmd": CMD_SWRC, "key": 0x16},
    "SWRC_TEST_17":     {"cmd": CMD_SWRC, "key": 0x17},
    "SWRC_TEST_18":     {"cmd": CMD_SWRC, "key": 0x18},
    "SWRC_TEST_19":     {"cmd": CMD_SWRC, "key": 0x19},
    "SWRC_TEST_1A":     {"cmd": CMD_SWRC, "key": 0x1A},
    "SWRC_TEST_1B":     {"cmd": CMD_SWRC, "key": 0x1B},
    "SWRC_TEST_1C":     {"cmd": CMD_SWRC, "key": 0x1C},
    "SWRC_TEST_1D":     {"cmd": CMD_SWRC, "key": 0x1D},
    "SWRC_TEST_1E":     {"cmd": CMD_SWRC, "key": 0x1E},
    "SWRC_TEST_1F":     {"cmd": CMD_SWRC, "key": 0x1F},
    "SWRC_TEST_2B":     {"cmd": CMD_SWRC, "key": 0x2B},
    "SWRC_TEST_2C":     {"cmd": CMD_SWRC, "key": 0x2C},
    "SWRC_TEST_2D":     {"cmd": CMD_SWRC, "key": 0x2D},
    "SWRC_TEST_2E":     {"cmd": CMD_SWRC, "key": 0x2E},
    "SWRC_TEST_2F":     {"cmd": CMD_SWRC, "key": 0x2F},
    "SWRC_TEST_30":     {"cmd": CMD_SWRC, "key": 0x30},
