...
ISAP_KEYS: dict[str, dict] = {
    ...
    "SWRC_TEST1":       {"cmd": CMD_SWRC, "key": 0x27},  # END(0x26) 직후 - 전화 클러스터 확장
    "SWRC_TEST2":       {"cmd": CMD_SWRC, "key": 0x14},  # MKBD_HOME 위치 매핑
    "SWRC_TEST3":       {"cmd": CMD_SWRC, "key": 0x21},  # PTT(0x22) 직전
    "SWRC_TEST4":       {"cmd": CMD_SWRC, "key": 0x29},  # MKBD_PHONE 위치 매핑
